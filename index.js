...
const pendingOrders = require('./src/routes/pendingOrders/index')
...
const makeOrderPending = require('./src/routes/makeOrderPending/index')
const makeOrderOnProcessing = require('./src/routes/makeOrderOnProcessing/index')
...
app.use(singleOrder)
app.use(makeOrderPending)
app.use(makeOrderOnProcessing)
